...
public interface IOutflowRepository
{
    ...
    Task<Entities.Outflow?> GetById(Guid outflowId, Guid tenantId ,CancellationToken ct = default);
    ...
    Task Delete(Entities.Outflow outflow, Guid tenantId,  CancellationToken ct = default);
}