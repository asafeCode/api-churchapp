...
{
    public Task<bool> ExistActiveUserWithId(Guid? userId, Guid tenantId ,CancellationToken ct = default);
    ...
    public Task<bool> ExistsUserWithName(string normalizedName, Guid tenantId, CancellationToken ct);
    public Task<Entities.User?> GetUserByName(string normalizedName, Guid tenantId, CancellationToken ct = default);
}